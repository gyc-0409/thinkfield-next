        ...
        {step === 'form' && (
          <div>
            ...
            <div className="space-y-3">
              <input value={title} onChange={e => setTitle(e.target.value)} placeholder="书名" className="w-full border border-gray-200 p-2.5 rounded-md text-sm focus:outline-none focus:border-gray-400" />
              <input value={author} onChange={e => setAuthor(e.target.value)} placeholder="作者" className="w-full border border-gray-200 p-2.5 rounded-md text-sm focus:outline-none focus:border-gray-400" />
              <input value={edition} onChange={e => setEdition(e.target.value)} placeholder="版本" className="w-full border border-gray-200 p-2.5 rounded-md text-sm focus:outline-none focus:border-gray-400" />
            </div>
            <button
