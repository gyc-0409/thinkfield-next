...
function ExercisesContent() {
  ...
  return (
    <div className="fixed inset-0 z-10 flex overflow-hidden bg-white">
      ...
      {/* 右侧内容区 */}
      <div className="flex-1 min-h-0 scroll-container p-8 pb-8 md:static pt-12 md:pt-8" style={{ WebkitMaskImage: 'linear-gradient(to bottom, black 92%, transparent 100%)', maskImage: 'linear-gradient(to bottom, black 92%, transparent 100%)' }}>
        {showAddExercise ? (
          <div className="max-w-xl mx-auto">
            ...
            <input value={newContent} onChange={e => setNewContent(e.target.value)} placeholder="来源（选填）" className="w-full border border-gray-200 p-3 rounded-md mb-4 text-sm focus:outline-none focus:border-gray-400" />
